...
const MassageModal = ({ product }) => {
    ...
    const [cartItem, setCartItem] = useState({ productID: "", productTitle: "", productImage: "", productPrice: "", main_area_id: "", user_location: "", user_location_id: "", user_sub_location: "", user_sub_location_id: "", user_sel_date: "",user_sel_date_row: "", productID: "", variationID: "", variationMinutes: 0, pax: "", user_requests: "", minimumTime: 0 });
    ...
    useEffect(() => {
        ...
        setCartItem({ productID: "", main_area_id: "", user_location: "", user_location_id: "", user_sub_location: "", user_sub_location_id: "", user_sel_date: "", productID: "", variationID: "", variationText: "", pax: "", user_requests: "" });
    ...
    const setDate = (date) => {
        ...
        setCartItem((inputs) => ({ ...inputs, 'user_sel_date': formattedDate, 'user_sel_date_row': date}))
    }
                                    ...
                                    <div className="massage-content">
                                        ...
                                        <ul className="detail-data">
                                            <li className={`user_input_1 ${(cartItem.user_location) ? 'active' : ""}`} id="location_value">
                                                <span>Location: </span> <p className="w3n_show_location">{cartItem.user_location} {(minStep <= 0 && cartItem.user_location !== '') && (<span href="#" onClick={(e) => { setStep(0) }}><Image src={Pen} height={10} width={10} /></span>)}</p>
                                            </li>
                                            <li className={`user_input_2 ${(cartItem.user_sub_location) ? 'active' : ""}`} id="sub_location_value">
                                                <span>Sub Location: </span> <p className="w3n_show_sub_location">{cartItem.user_sub_location} {(minStep <= 0 && cartItem.user_sub_location !== '') && (<span href="#" onClick={(e) => { setStep(1) }}><Image src={Pen} height={10} width={10} /></span>)}</p>
                                            </li>
                                            <li className={`user_input_3 ${(cartItem.user_sel_date) ? 'active' : ""}`} id="user_sel_date_value">
                                                <span>Date / Time: </span> <p className="w3n_show_sel_date">{cartItem.user_sel_date} {(minStep <= 0 && cartItem.user_sel_date !== '') && (<span href="#" onClick={(e) => { setStep(2) }}><Image src={Pen} height={10} width={10} /></span>)}</p>
                                            </li>
                                            <li className={`user_input_4 ${(cartItem.variationText) ? 'active' : ""}`}>
                                                <span>Duration: </span> <p className="w3n_show_sel_hour">{cartItem.variationText} {(cartItem.variationText !== '') && (<span href="#" onClick={(e) => { setStep(3) }}><Image src={Pen} height={10} width={10} /></span>)}</p>
                                            </li>
                                        ...
                                        <div className="estimate">
                                            ...
                                            {(step == 2) && (
                                                <Datetime dateFormat="YYYY/MM/DD" timeFormat="HH:mm" timeConstraints={{
                                                    hours: { min: 14, max: 23, seed: 14 },
                                                    minutes: { min: 0, max: 0, seed: 0 },
                                                }} onChange={setDate}
                                                onClose={(e) => {(cartItem.user_sel_date !== '')?setStep(3):''}}
                                                value={cartItem.user_sel_date_row}
                                            ...
                                            {(step == 3) && (
                                                <Select
                                                    ...
                                                    className="react-select-container"
                                                    classNamePrefix="react-select"
                                                    onChange={(e) => { setCartItem((inputs) => ({ ...inputs, 'variationID': e.value, "variationText": e.label, 'productPrice': e.display_price, variationMinutes: e.minutes })); setPriceHtml(e.price); (e.value !== '')?setStep(4):''; }}
